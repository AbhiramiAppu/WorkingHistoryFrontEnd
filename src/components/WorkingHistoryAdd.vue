                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-4 pb-2">
                                                <label class="form-label" for="form3Examplev2">Employee ID</label>
                                                <select class="form-control form-control" required v-model="employees.employeeIdNumber">
                                            ...
                                            <div class="mb-4 pb-2">
                                                ...
                                                <select class="form-control form-control" required v-model="employees.employerName">
                                                    <option value="">--Select--</option>
                                                        <option value="1">Liya</option><option value="2">Abhirami</option>
                                                        <option value="3">Aishwarya</option><option value="4">Saumyadip</option>
                                                        <option value="5">Kishor</option>
                                                </select>
                                            </div>
...
export default {
  ...
  methods: {        
    saveEmployee() {
      ...
      WorkHistoryService.createEmployeeWorkHistory(data)
        .then(response => {
